(function (global, factory) {
    ...
    var ReadableStream = /** @class */ (function () {
        ...
        ReadableStream.prototype.getIterator = function (_a) {
            var preventCancel = (_a === void 0 ? {} : _a).preventCancel;
            if (IsReadableStream(this) === false) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (signal !== undefined) {
                abortAlgorithm = function () {
                    ...
                    shutdownWithAction(function () { return WaitForAllPromise(actions.map(function (action) { return action(); }), function (results) { return results; }); }, true, error);
                };
